...
class Home extends BaseController
{
    ...
    {
        $aset = count(model(AsetModel::class)->findAll());
        $gedung = count(model(GedungModel::class)->findAll());
        $ruangan = count(model(RuanganModel::class)->findAll());
    ...
    //     // Cari jumlah aset yang sudah ada di ruangan yang sama
    //     $count = $asetModel->where('id_ruangan', $kode_ruangan)
    //         ->countAllResults();
